...
# Lightweight (242Mb...[![Docker Image Size](https://badgen.net/docker/size/d3fk/mailman2/latest?icon=docker&label=compressed)](https://hub.docker.com/r/d3fk/mailman2/tags) ) useful mailman2 from buster-slim (Angatar> d3fk/mailman2)
